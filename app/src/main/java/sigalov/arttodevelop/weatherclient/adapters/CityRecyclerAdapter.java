...
public class CityRecyclerAdapter extends RecyclerView.Adapter<CityRecyclerAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            temperatureTextView = (TextView) v.findViewById(R.id.city_item_temperature);
            windTextView = (TextView) v.findViewById(R.id.city_item_wind);
            directionTextView = (TextView) v.findViewById(R.id.city_item_direction);
        }
    }
    ...
    @Override
    public void onBindViewHolder(CityRecyclerAdapter.ViewHolder holder, int position) {
